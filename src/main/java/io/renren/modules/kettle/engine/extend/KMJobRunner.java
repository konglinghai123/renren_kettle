...
package io.renren.modules.kettle.engine.extend;
...
public class KMJobRunner extends AbsJob {
        ...
        for(Integer jobId:jobIdList.toArray(new Integer[]{})){
            ...
            if(jobJson != null){
                try {
                    ...
                    JobManager.startJob(Underline2Camel.Json2Object(jobJson,VJobEntity.class));
